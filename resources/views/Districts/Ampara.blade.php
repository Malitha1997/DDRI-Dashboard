            ...
            <div class="row" style="width: 1430px;">
                <div class="col">
                    <div class="row">
                        ...
                        <a class="btn btn-primary d-flex flex-row justify-content-center align-items-start" type="button" style="margin-left: 0px;background: url(&quot;{{ asset('img/Back.png') }}&quot;), rgba(13,110,253,0);border-color: rgba(255,255,255,0);width: 30px;height: 30px;" href="{{route('home')}}"></a><span data-aos="fade-down" data-aos-duration="750" style="color: #09184B;font-size: 34px;font-weight: bold;font-family: 'Poppins';text-align: center;"><br>Ampara District Digital Readiness Index<br><br></span></div>
                    </div>
