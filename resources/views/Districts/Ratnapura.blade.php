...
@section('content')
        ...
        <div class="container" id="div3">
            <div class="row">   
                ...
                <div class="col-lg-10">
                    <h3 data-aos="fade-down" data-aos-duration="750" style="color: #09184B;font-weight: bold;font-family: 'Poppins';text-align: center;">Ratnapura District Digital Readiness Index<br><br></h3>
                </div>
