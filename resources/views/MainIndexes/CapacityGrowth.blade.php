                    ...
                    <div class="row">
                        <div class="col" style="text-align: center;">
                            <div class="row" data-aos="fade-down" data-aos-duration="1000" > 
                                <a class="btn btn-primary d-flex flex-row justify-content-center align-items-start" type="button" style="margin-left: 0px;background: url(&quot;{{ asset('img/Back.png') }}&quot;), rgba(13,110,253,0);border-color: rgba(255,255,255,0);width: 30px;height: 30px;" href="{{route('home')}}"></a><h5 style="color: #09184B;font-weight: bold;font-family: 'Poppins';text-align: center;">Regional Capacity Growth Readiness</h5>
                            </div>
                        </div>
                    </div>
                    <div class="row">
